...
if __name__ == "__main__":
    save_sym("./tests/test_1.txt", "./tests/result_1.csv")
    save_sym("./tests/test_2.txt", "./tests/result_2.csv")
    save_sym("./tests/test_3.txt", "./tests/result_3.csv")
    save_sym("./tests/test_4.txt", "./tests/result_4.csv")
    save_sym("./tests/test_5.txt", "./tests/result_5.csv")
